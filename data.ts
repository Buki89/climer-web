export const data = [
  ...
  "Komu není shůry dáno, v apatyce nekoupí[4].",
  ...
  "Snídani sněz sám, o oběd se poděl s přítelem a večeři dej nepříteli[6].",
  "Starého psa novým kouskům nenaučíš.",
  "Stokrát nic umořilo osla.",
  "Stokrát opakovaná lež se stává pravdou.",
  "Strach má velké oči[pozn 2].",
  "Svůj k svému.",
  "Sytý hladovému nevěří.",
  "Šaty dělaj člověka.",
  "Ševcova žena a kovářova kobyla chodí bosy.",
  "Ševče, drž se svého kopyta.",
  "Šij nebo párej, všechno robota[8].",
